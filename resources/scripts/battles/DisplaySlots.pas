...
for I := 1 to 12 do
  ...
  begin
    if (GetInt('Slot' + IntToStr(I) + 'HP') > GetInt('Slot' + IntToStr(I) + 'MHP')) then
      LetVar('Slot' + IntToStr(I) + 'HP', 'Slot' + IntToStr(I) + 'MHP');
    ...
    else if (GetInt('DisplayDamageSlot' + IntToStr(I)) > 0) then
    begin
      // Урон
