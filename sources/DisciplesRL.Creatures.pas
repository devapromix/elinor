...
const
  RaceDescription: array [TRaceEnum] of array [0 .. 8] of string = (('', '', '', '', '', '', '', '', ''),
    // Пока молодые люди подбирали новые ножны к своим сверкающим мечам,
    // Старейшины всматривались в небо, взывая к Небесному Отцу. Ведь он
    // же не позволит ужасу наводнить вновь эти благодатные земли? Но сейчас эту
    // землю раздирают склоки и раздоры. Множество мелких аристократов и разбойничьих
    // атаманов провозгласили собственные королевства. Некогда гордая и единая Империя,
    // что создавалась тысячи лет, осталась лишь в воспоминаниях. Король, потеряв во
    // время войны супругу и единственного сына, добровольно уединился в самой высокой
    // башне своего замка.

    { }

    // The Empire
    ('Империя пришла в упадок. Больше', 'не радуют глаз возделанные поля и цве-', 'тущие сады. Землю раздирают склоки и', 'раздоры. Аристократы и разбойничьи', 'атаманы провозгласили собственные','королевства. Некогда гордая и единая','Империя, что создавалась тысячи лет,',' осталась лишь в воспоминаниях.', ''),
    // Undead Hordes
    ('', '', '', '', '', '', '', '', ''),
