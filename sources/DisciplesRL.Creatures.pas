...
const
  CreatureBase: array [TCreatureEnum] of TCreatureBase = (
    ...
    SourceEnum: seWeapon; ReachEnum: reAdj; Targets: 1;),
    // Wolf
    (ResEnum: reUnk; Name: 'Волк'; HitPoints: 180; Initiative: 50; ChancesToHit: 80; Leadership: 0; Level: 1; Damage: 55; Armor: 0;
    SourceEnum: seWeapon; ReachEnum: reAdj; Targets: 1;),
    // Orc
    (ResEnum: reUnk; Name: 'Орк'; HitPoints: 200; Initiative: 40; ChancesToHit: 80; Leadership: 0; Level: 1; Damage: 55; Armor: 0;
    SourceEnum: seWeapon; ReachEnum: reAdj; Targets: 1;)
    //
    );
