...
type
  ...
  STREAMPROC = function(Handle: HSTREAM; buffer: Pointer; Length: DWORD; user:
...
type
  ...
  DSPPROC = procedure(Handle: HDSP; channel: DWORD; buffer: Pointer; Length:
    DWORD; user: Pointer); stdcall;
  {
  ...
  RECORDPROC = function(Handle: HRECORD; buffer: Pointer; Length: DWORD; user:
...
function BASS_Init(device: Integer; freq, flags: DWORD; win: HWND; clsid:
  PGUID): Bool; stdcall; external bassdll;
...
function BASS_PluginGetInfo(Handle: HPLUGIN): PBASS_PLUGININFO; stdcall; external
  bassdll;

function BASS_Set3DFactors(distf, rollf, doppf: FLOAT): Bool; stdcall; external
  bassdll;
...
function BASS_MusicLoad(mem: Bool; F: Pointer; offset: QWORD; Length, flags,
  freq: DWORD): HMUSIC; stdcall; external bassdll;
function BASS_MusicFree(Handle: HMUSIC): Bool; stdcall; external bassdll;

function BASS_SampleLoad(mem: Bool; F: Pointer; offset: QWORD; Length, Max,
  flags: DWORD): HSAMPLE; stdcall; external bassdll;
...
function BASS_StreamCreate(freq, chans, flags: DWORD; proc: STREAMPROC; user:
  Pointer): HSTREAM; stdcall; external bassdll;
function BASS_StreamCreateFile(mem: Bool; F: Pointer; offset, Length: QWORD;
  flags: DWORD): HSTREAM; stdcall; external bassdll;
function BASS_StreamCreateURL(url: PChar; offset: DWORD; flags: DWORD; proc:
  DOWNLOADPROC; user: Pointer): HSTREAM; stdcall; external bassdll;
function BASS_StreamCreateFileUser(System, flags: DWORD; var procs:
  BASS_FILEPROCS; user: Pointer): HSTREAM; stdcall; external bassdll;
...
function BASS_StreamPutFileData(Handle: HSTREAM; buffer: Pointer; Length:
  DWORD): DWORD; stdcall; external bassdll;
...
function BASS_RecordGetInfo(var info: BASS_RECORDINFO): Bool; stdcall; external
  bassdll;
function BASS_RecordGetInputName(input: Integer): PChar; stdcall; external
  bassdll;
...
function BASS_RecordGetInput(input: Integer; var volume: FLOAT): DWORD; stdcall;
  external bassdll;
function BASS_RecordStart(freq, chans, flags: DWORD; proc: RECORDPROC; user:
  Pointer): HRECORD; stdcall; external bassdll;
...
function BASS_ChannelSetDevice(Handle, device: DWORD): Bool; stdcall; external
  bassdll;
...
function BASS_ChannelGetTags(Handle: HSTREAM; tags: DWORD): PChar; stdcall;
  external bassdll;
function BASS_ChannelFlags(Handle, flags, Mask: DWORD): DWORD; stdcall; external
  bassdll;
function BASS_ChannelUpdate(Handle, Length: DWORD): Bool; stdcall; external
  bassdll;
function BASS_ChannelLock(Handle: DWORD; lock: Bool): Bool; stdcall; external
  bassdll;
function BASS_ChannelPlay(Handle: DWORD; restart: Bool): Bool; stdcall; external
  bassdll;
...
function BASS_ChannelGetAttribute(Handle, attrib: DWORD; var Value: FLOAT):
  Bool; stdcall; external bassdll;
function BASS_ChannelSlideAttribute(Handle, attrib: DWORD; Value: FLOAT; Time:
  DWORD): Bool; stdcall; external bassdll;
function BASS_ChannelIsSliding(Handle, attrib: DWORD): Bool; stdcall; external
  bassdll;
function BASS_ChannelSet3DAttributes(Handle: DWORD; Mode: Integer; Min, Max:
  FLOAT; iangle, oangle, outvol: Integer): Bool; stdcall; external bassdll;
function BASS_ChannelGet3DAttributes(Handle: DWORD; var Mode: DWORD; var Min,
  Max: FLOAT; var iangle, oangle, outvol: DWORD): Bool; stdcall; external bassdll;
function BASS_ChannelSet3DPosition(Handle: DWORD; var Pos, orient, vel:
  BASS_3DVECTOR): Bool; stdcall; external bassdll;
function BASS_ChannelGet3DPosition(Handle: DWORD; var Pos, orient, vel:
  BASS_3DVECTOR): Bool; stdcall; external bassdll;
function BASS_ChannelGetLength(Handle, Mode: DWORD): QWORD; stdcall; external
  bassdll;
function BASS_ChannelSetPosition(Handle: DWORD; Pos: QWORD; Mode: DWORD): Bool;
  stdcall; external bassdll;
function BASS_ChannelGetPosition(Handle, Mode: DWORD): QWORD; stdcall; external
  bassdll;
...
function BASS_ChannelGetData(Handle: DWORD; buffer: Pointer; Length: DWORD):
  DWORD; stdcall; external bassdll;
function BASS_ChannelSetSync(Handle: DWORD; type_: DWORD; param: QWORD; proc:
  SYNCPROC; user: Pointer): HSYNC; stdcall; external bassdll;
...
function BASS_ChannelRemoveDSP(Handle: DWORD; dsp: HDSP): Bool; stdcall; external
  bassdll;
function BASS_ChannelSetLink(Handle, chan: DWORD): Bool; stdcall; external
  bassdll;
function BASS_ChannelRemoveLink(Handle, chan: DWORD): Bool; stdcall; external
  bassdll;
function BASS_ChannelSetFX(Handle, type_: DWORD; priority: Integer): HFX;
  stdcall; external bassdll;
function BASS_ChannelRemoveFX(Handle: DWORD; fx: HFX): Bool; stdcall; external
  bassdll;

function BASS_FXSetParameters(Handle: HFX; par: Pointer): Bool; stdcall; external
  bassdll;
function BASS_FXGetParameters(Handle: HFX; par: Pointer): Bool; stdcall; external
  bassdll;
...
begin
  case (env) of
    ...
    EAX_ENVIRONMENT_BATHROOM:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_BATHROOM, 0.653, 1.499,
        0.166);
    EAX_ENVIRONMENT_LIVINGROOM:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_LIVINGROOM, 0.208, 0.478,
        0);
    EAX_ENVIRONMENT_STONEROOM:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_STONEROOM, 0.5, 2.309,
        0.888);
    EAX_ENVIRONMENT_AUDITORIUM:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_AUDITORIUM, 0.403, 4.279,
        0.5);
    EAX_ENVIRONMENT_CONCERTHALL:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_CONCERTHALL, 0.5, 3.961,
        0.5);
    EAX_ENVIRONMENT_CAVE:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_CAVE, 0.5, 2.886, 1.304);
    EAX_ENVIRONMENT_ARENA:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_ARENA, 0.361, 7.284,
        0.332);
    ...
    EAX_ENVIRONMENT_ALLEY:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_ALLEY, 0.25, 1.752,
        0.776);
    EAX_ENVIRONMENT_FOREST:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_FOREST, 0.111, 3.145,
        0.472);
    EAX_ENVIRONMENT_CITY:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_CITY, 0.111, 2.767,
        0.224);
    EAX_ENVIRONMENT_MOUNTAINS:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_MOUNTAINS, 0.194, 7.841,
        0.472);
    EAX_ENVIRONMENT_QUARRY:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_QUARRY, 1, 1.499, 0.5);
    EAX_ENVIRONMENT_PLAIN:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_PLAIN, 0.097, 2.767,
        0.224);
    EAX_ENVIRONMENT_PARKINGLOT:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_PARKINGLOT, 0.208, 1.652,
        1.5);
    EAX_ENVIRONMENT_SEWERPIPE:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_SEWERPIPE, 0.652, 2.886,
        0.25);
    EAX_ENVIRONMENT_UNDERWATER:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_UNDERWATER, 1, 1.499, 0);
    EAX_ENVIRONMENT_DRUGGED:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_DRUGGED, 0.875, 8.392,
        1.388);
    EAX_ENVIRONMENT_DIZZY:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_DIZZY, 0.139, 17.234,
        0.666);
    EAX_ENVIRONMENT_PSYCHOTIC:
      Result := BASS_SetEAXParameters(EAX_ENVIRONMENT_PSYCHOTIC, 0.486, 7.563,
        0.806);
  else
    Result := False;
  end;
